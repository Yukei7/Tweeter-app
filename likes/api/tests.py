...
class LikeApiTest(TestCase):
    ...
    def test_tweet_likes(self):
        ...
        response = self.anonymous_cli.post(LIKE_BASE_URL, data)
    ...
    def test_cancel(self):
        ...
        # login required
        response = self.anonymous_cli.post(LIKE_CANCEL_URL, like_comment_data)
        self.assertEqual(response.status_code, 403)
    ...
    def test_likes_in_comments(self):
        ...
        # test anonymous user
        response = self.anonymous_cli.get(COMMENT_LIST_API, {'tweet_id': tweet.id})
        self.assertEqual(response.status_code, 200)
